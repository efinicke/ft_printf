...
/*   Updated: 2021/04/01 12:59:07 by efinicke         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int moul_d_3(void){return ft_printf("Il fait au minus %d\n", -8000);}
...
int moul_c_3(void){return ft_printf("Il fait au minus %c\n", -8000);}
...
int moul_i_3(void){return ft_printf("Il fait au minus %i\n", -8000);}
...
int moul_u_3(void){return ft_printf("Il fait au minus %u\n", -8000);}
...
int moul_x_3(void){return ft_printf("Il fait au minus %x\n", -8000);}
...
int moul_d_3_bench(void){return printf("Il fait au minus %d\n", -8000);}
...
int moul_c_3_bench(void){return printf("Il fait au minus %c\n", -8000);}
...
int moul_i_3_bench(void){return printf("Il fait au minus %i\n", -8000);}
...
int moul_u_3_bench(void){return printf("Il fait au minus %u\n", -8000);}
...
int moul_x_3_bench(void){return printf("Il fait au minus %x\n", -8000);}
...
const t_test_entry g_unit_tests[] = {
	...
	{1, 631, "moul_d_3", moul_d_3, moul_d_3_bench, "{return test(\"Il fait au minus %d\n\", -8000);}"},
	...
	{1, 644, "moul_c_3", moul_c_3, moul_c_3_bench, "{return test(\"Il fait au minus %c\n\", -8000);}"},
	...
	{1, 673, "moul_i_3", moul_i_3, moul_i_3_bench, "{return test(\"Il fait au minus %i\n\", -8000);}"},
	...
	{1, 685, "moul_u_3", moul_u_3, moul_u_3_bench, "{return test(\"Il fait au minus %u\n\", -8000);}"},
	...
	{1, 697, "moul_x_3", moul_x_3, moul_x_3_bench, "{return test(\"Il fait au minus %x\n\", -8000);}"},
